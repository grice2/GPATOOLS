...
#' @examples get_power_1n(data = df, treatment = "ads", suvey_q = "q4",  counts="responses", size = "total", alt="greater", control = "Control")
#' @examples get_power_1n(data = df, treatment = "ads", suvey_q = "q4",  counts="responses", size = "total", alt="greater", control = "Biden")
#' @export
