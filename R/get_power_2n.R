...
#' @examples get_power_2n(data = df, treatment = "ads", suvey_q = "Q4",  n1=1200, n2=600, alt="greater", control = "Control")
#' @examples get_power_2n(data = df, treatment = "ads", suvey_q = "Q4",  n1=1200, n2=600, alt="greater", control = "Naturalization")
#' @export
