...
#' @examples get_alpha(data = df, treatment = "ads", suvey_q = "q4", counts="responses", size = "total", alt="greater", control = "Control")
#' @examples get_alpha(data = df, treatment = "ads", suvey_q = "q4", counts="responses", size = "total", alt="greater", control = "Biden")
#' @export
