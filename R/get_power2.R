...
#' @param sample1 Sample size for treatments 
#' @param sample2 Sample size for control
...
#' @examples get_power1(data = df, treatment = "ads", suvey_q = "Q4",  n1=1200, n2=600, alt="greater")
#' @export
